...
1.  **Posit Cloud** ([https://posit.co/products/cloud/cloud/)](https://posit.co/products/cloud/cloud/)){.uri} provides access to Posit's powerful set of data science tools, including:
...
2.  **RStudio Desktop** ([https://posit.co/products/open-source/rstudio)](https://posit.co/products/open-source/rstudio)){.uri} is a free desktop application of the RStudio IDE for R that runs on Windows, MacOS or Linux. Its advantages over Posit Cloud include offline access, full control over the local environment, customization options, data privacy and security, and the ability to leverage the full resources of your local machine, such as CPU, memory, and storage.

3.  **R Pubs** ([https://rpubs.com)](https://rpubs.com)){.uri} is a free and easy web publishing platform for R and alternative to Quarto Pubs. To publish these documents via RPubs, however, you will first need to create an account here: <https://rpubs.com/users/new.>
