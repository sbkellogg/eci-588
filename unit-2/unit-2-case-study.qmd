...
[![Rosenberg, J., Borchers, C., Dyer, E., Anderson, D., & Fischer, C. (2021). Understanding Public Sentiment About Educational Reforms: The Next Generation Science Standards on Twitter. *AERA Open, 7*. <https://doi.org/10.1177/23328584211024261>](images/rosenberg.jpg){fig-alt="Full Paper (AERA Open)" width="50%"}](https://doi.org/10.1177/23328584211024261)
...
```{r}
ngss_tweets <- read_csv(#YOUR CODE HERE, 
  col_types = cols(author_id = col_character(), 
                   id = col_character(),
                   conversation_id = col_character(), 
                   in_reply_to_user_id = col_character()
