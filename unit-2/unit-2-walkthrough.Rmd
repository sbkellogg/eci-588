...
We have one last step to tidy our text that hopefully should feel familiar familiar by this point.

### 2c. Get Sentiments

Now that we've tidFor this part of our workflow we focus on the following functions from the [`tidytext`](https://cran.r-project.org/web/packages/tidytext/) and `dplyr` packages respectively:
