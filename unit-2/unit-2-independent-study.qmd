...
1.  **Independent Analysis**: For students who have completed ECI 586 or are comfortable with R basics, you will have the options this week to create a simple "data product" designed to illustrate your ability to apply basic sentiment analysis techniques demonstrated in the case study.
...
3.  **Soraya Campbell**: [Study Abroad and Covid Sentiment Analysis](https://sorayaworldwide.github.io/studyabroad_covid19.html#1) \[[code](https://github.com/sorayaworldwide/studyabroadcovid)\]
