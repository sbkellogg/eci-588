...
Not surprisingly, the Tidyverse set of packages including packages like `dplyr` adhere ["tidy" data](https://r4ds.hadley.nz/data-tidy.html#sec-tidy-data) principles [@wickham2023r]. Tidy data has a specific structure:
