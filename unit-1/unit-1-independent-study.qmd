...
2.  **Datacamp Tutorials**: For students new to R or have not completed ECI 586: Intro to Learning Analytics, you will be required to complete two Datacamp tutorials focused on the basics [data visualization](https://www.datacamp.com/courses/introduction-to-data-visualization-with-ggplot2), and [wrangling and visualizing text](https://app.datacamp.com/learn/courses/introduction-to-text-analysis-in-r).
...
4.  **Create a data product.** When you feel you've wrangled and analyzed the data to your satisfaction, create an Quarto file that includes a polished sociogram and/or data table and a narrative highlighting your research question, data source, and key findings and potential implications. Your file should include a polished graph and/or table, a title and narrative, and all code necessary to read, wrangle, and explore your data.

5.  **Share your findings.** Render your data product to a desired output format. I recommend using the example data product I've included in the project folder to great an HTML slide deck, but you are welcome to experiment with other formats as well.
