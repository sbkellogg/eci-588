...
Run the following code to tidy our text, save it as a new data frame named `opd_tidy`, and print the first 10 rows:
...
Congratulations, we're not ready to begin exploring our wrangled data!
