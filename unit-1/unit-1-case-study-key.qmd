...
As you've probably already noticed from viewing our dataset, we clearly have more data than we need to answer our rather basic research question. For this part of our workflow we focus on the following functions from the tidyverse [`dplyr` package](https://dplyr.tidyverse.org) for wrangling our data:
...
In this section, our goal is to transform our `opd_teacher` data from this:
