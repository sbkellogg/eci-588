...
The primary goal of the Unit 1 readings and discussion is to introduce general techniques and applications of text mining in education and look at more specific examples of their use in educational contexts. A secondary goal of our readings and discussion in each unit is to help you start generating ideas for independent analysis and your final course project.

## READINGS

To help address our discussion questions for the week, you'll be asked to read or view three resources, including: a required joural article, an instructor-selected resource, and one additional self-selected resource such as a journal article, video, news article, podcast, or blog post.
...
-   What sources of data are commonly used in text mining, particularly in educational contexts?

-   Are some data sources more suitable or appropriate for text mining purposes than others?

-   What data sources in education are publicly available for analysis?

-   What sources of data are you interested in potentially exploring for an independent analysis or final course project?
